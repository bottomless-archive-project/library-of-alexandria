...
- https://www.oracle.com/technetwork/java/javase/downloads/index.html[Java 13]
- https://www.mongodb.com/download-center/community[MongoDB 4.2]

List of the required software to be able to search the archived documents:

- https://www.elastic.co/downloads/past-releases/elasticsearch-7-5-0[Elasticsearch 7.5.0]
